...
const ChantList = () => {
  ...
  // Récupération des chants depuis Firebase
  useEffect(() => {
  ...
  const saveEdit = async () => {
    ...
    // Nettoyage des données avant l'envoi à Firebase
    const cleanedChant = {
      ...editChant,
      youtubeLink: editChant.youtubeLink || "", // Remplacer undefined par ""
      category: editChant.category || "Adoration", // Valeur par défaut
      note: editChant.note || "Do", // Valeur par défaut
    };
